...
app.get("/api/analytics/top-artists", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM top_20_artists ORDER BY mentions DESC');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/top-songs", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM top_20_tracks ORDER BY mentions DESC');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/top-albums", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM top_20_albums ORDER BY mentions DESC');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/top-artist-shared", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM users_share_top_artist LIMIT 10');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/top3-identical", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM top3_identical_lists ORDER BY user_count DESC LIMIT 10');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/artist-pairs", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM frequent_artist_pairs ORDER BY cooccurrence_count DESC LIMIT 50');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/artist-triplets", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM frequent_artist_triplets ORDER BY cooccurrence_count DESC LIMIT 20');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/avg-artist-position", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM avg_artist_position ORDER BY avg_rank ASC LIMIT 30');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/active-listeners", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM top_artists_active_listeners ORDER BY listener_count DESC LIMIT 20');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/cross-popularity", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM cross_popularity ORDER BY ABS(difference) DESC LIMIT 30');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/artist-diversity", async (req, res) => {
  try {
    const [rows] = await db.query('SELECT * FROM artist_diversity ORDER BY unique_users DESC LIMIT 50');
    res.json(rows);
  } catch (error) {
...
app.get("/api/analytics/dashboard", async (req, res) => {
  try {
    ...
    const [topArtists] = await db.query('SELECT * FROM top_20_artists ORDER BY mentions DESC LIMIT 5');
...
app.listen(PORT, () => {
  ...
  console.log(`   Database: ${process.env.MARIADB_HOST}:${process.env.MARIADB_PORT}`);
});
